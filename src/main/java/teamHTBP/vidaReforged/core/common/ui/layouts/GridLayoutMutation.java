package teamHTBP.vidaReforged.core.common.ui.layouts;
...
public class GridLayoutMutation extends AbstractLayout {
    protected final List<LayoutElement> children = new ArrayList<>();
    protected final List<GridLayoutMutation.CellInhabitant> cellInhabitants = new ArrayList<>();
    protected final LayoutSettings defaultCellSettings = LayoutSettings.defaults();
    protected int rowSpacing = 0;
    protected int columnSpacing = 0;

    public GridLayoutMutation() {
        this(0, 0);
    }

    public GridLayoutMutation(int x, int y) {
        super(x, y, 0, 0);
    }
    ...
    public void arrangeElements() {
        ...
        for(GridLayoutMutation.CellInhabitant gridlayout$cellinhabitant : this.cellInhabitants) {
        ...
        for(GridLayoutMutation.CellInhabitant gridlayout$cellinhabitant1 : this.cellInhabitants) {
        ...
        for(GridLayoutMutation.CellInhabitant gridlayout$cellinhabitant2 : this.cellInhabitants) {
            int i2 = 0;
    ...
    public <T extends LayoutElement> T addChild(T p_265031_, int p_265582_, int p_265782_, int p_265612_, int p_265448_, LayoutSettings p_265579_) {
        if (p_265612_ < 1) {
            ...
            this.cellInhabitants.add(new GridLayoutMutation.CellInhabitant(p_265031_, p_265582_, p_265782_, p_265612_, p_265448_, p_265579_));
            this.children.add(p_265031_);
            return p_265031_;
        }
    }

    public GridLayoutMutation columnSpacing(int p_268135_) {
        this.columnSpacing = p_268135_;
        return this;
    }

    public GridLayoutMutation rowSpacing(int p_268237_) {
        this.rowSpacing = p_268237_;
        return this;
    }

    public GridLayoutMutation spacing(int p_268351_) {
    ...
    public GridLayoutMutation.RowHelper createRowHelper(int p_265327_) {
        return new GridLayoutMutation.RowHelper(p_265327_);
    }
    ...
    public final class RowHelper {
        ...
        public <T extends LayoutElement> T addChild(T p_265200_, int p_265044_, LayoutSettings p_265797_) {
            ...
            return GridLayoutMutation.this.addChild(p_265200_, i, j, 1, p_265044_, p_265797_);
        }

        public GridLayoutMutation getGrid() {
            return GridLayoutMutation.this;
        }

        public LayoutSettings newCellSettings() {
            return GridLayoutMutation.this.newCellSettings();
        }

        public LayoutSettings defaultCellSetting() {
            return GridLayoutMutation.this.defaultCellSetting();
        }
    }
}
