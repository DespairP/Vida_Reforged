...
public class BezierLazerParticle extends TrailParticle {
    public List<Vector3d> tails = new ArrayList<>();

    public BezierLazerParticle(ClientLevel level, double x, double y, double z, double speedX, double speedY, double speedZ, int a, int r, int g, int b, int size, int age, List<Vector3d> tails) {
